...
export default function Register() {
    ...
    //         <form className='w-[40rem] p-4 bg-black' onSubmit={handleRegister}>
    ...
    return (
        <section className="h-screen">
            <div className="h-full">
                ...
                <div
                    className="flex h-full flex-wrap items-center justify-center lg:gap-10">
                    <div
                        className="shrink-1 flex justify-center mb-12 grow-0 basis-auto md:mb-0 md:w-9/12 md:shrink-0 lg:w-6/12 xl:w-6/12">
                        <img
                            src="https://th.bing.com/th/id/R.c744afc9c17034c095b95ad9842b944f?rik=vSzYEF8hVu4EhQ&riu=http%3a%2f%2fwww.clipartbest.com%2fcliparts%2f4cb%2fpXE%2f4cbpXEpcg.jpeg&ehk=6mBMWJDFLmAG00p6PgoPdCTwsGHidqhwL4rGXzIY11U%3d&risl=&pid=ImgRaw&r=0"
